...
COMMAND_REGISTRY: dict[str, list[tuple[str, str]]] = {
    ...
    "Review": [
        ...
        ("review_purge", "Bulk-delete pending candidates older than N days (/review_purge [N])"),
    ...
    "Feature Requests": [
        ("feature",          "Capture a new feature request. Use for:<project> to tag a project (e.g. /feature for:myapp Fix login)"),
        ("feature_new",      "Alias of /feature"),
        ("bug",              "Capture a new bug report. Use for:<project> to tag a project (e.g. /bug for:myapp Crash on login)"),
        ("bugs",             "List bug reports (alias of /features bug)"),
        ("features",         "List feature requests. Filter: bug|feature|<status>|all|project:<name>"),
