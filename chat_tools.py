...
TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "function": {
            "name": "list_notes",
            "description": (
                "List Apple Notes from memory. Call this when the user asks about their notes, "
                "Apple Notes, or 'what notes do I have?'. Use todos_only=true to show only "
                "notes flagged as containing checklist or todo items. Use folder to filter "
                "by folder name."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "folder": {
                        "type": "string",
                        "description": "Optional folder name to filter by (partial match)",
                    },
                    "todos_only": {
                        "type": "boolean",
                        "description": "If true, show only notes containing checklist/todo items",
                    },
    ...
    },
    {
        ...
        "function": {
            "name": "get_note",
            "description": (
                "Get the full content of a specific Apple Note by its list index. "
                "Call list_notes first to get the numbered list, then use get_note "
                "with the index number to see the full note text."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "index": {
                        "type": "integer",
                        "description": "1-based position from the last list_notes result",
                    },
                },
                "required": ["index"],
            },
    ...
    },
    {
        ...
        "function": {
            "name": "list_insights",
            "description": (
                "List recent synthesis insights — cross-memory analysis generated by the "
                "index builder. Call this when the user asks about insights, patterns, "
                "or synthesis across their memories."
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "list_aichat",
            "description": (
                "List imported LLM conversation history (Claude.ai and ChatGPT chats). "
                "Call this when the user asks about their past AI conversations, "
                "imported chats, or what they've discussed with AI assistants."
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "get_aichat",
            "description": (
                "Get full detail for a specific imported LLM conversation by its list index. "
                "Call list_aichat first to get the numbered list, then use get_aichat "
                "with the index number to see summary, topics, and tags."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "index": {
                        "type": "integer",
                        "description": "1-based position from the last list_aichat result",
                    },
                },
                "required": ["index"],
            },
